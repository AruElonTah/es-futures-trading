...
class TestMaxContractsCap:
    ...
    async def test_max_contracts_cap_clamps_result(self) -> None:
        ...
        state = _make_state()
        decision = await rm.check(signal, state)
...
class TestDrawdownModelVariants:
    ...
    async def test_drawdown_model_static_approves_valid_signal(self) -> None:
    ...
    async def test_drawdown_model_trailing_eod_approves_valid_signal(self) -> None:
    ...
    async def test_drawdown_model_trailing_intraday_approves_valid_signal(self) -> None:
    ...
    async def test_hwm_static_never_decreases(self) -> None:
...
class TestDDFloorViolation:
    ...
    async def test_dd_floor_violation_rejected(self) -> None:
    ...
    async def test_dd_floor_not_violated_when_safe(self) -> None:
...
class TestDailyDDBreaker:
    ...
    async def test_daily_dd_breaker_rejected(self) -> None:
    ...
    async def test_daily_dd_breaker_at_exact_limit(self) -> None:
    ...
    async def test_daily_dd_not_tripped_when_within_limit(self) -> None:
...
class TestKillSwitch:
    ...
    async def test_kill_switch_rejects_signal(self) -> None:
    ...
    async def test_kill_switch_clears_on_running(self) -> None:
    ...
    async def test_kill_switch_bootstrap_from_db(self) -> None:
...
class TestConcurrencyCap:
    ...
    async def test_concurrency_cap_rejected(self) -> None:
    ...
    async def test_different_strategy_not_blocked(self) -> None:
    ...
    async def test_concurrency_cap_uses_positions_dict(self) -> None:
...
class TestApprovedSignal:
    ...
    async def test_approved_signal_returns_adjusted_size(self) -> None:
    ...
    async def test_approved_signal_respects_max_contracts_cap(self) -> None:
    ...
    async def test_approved_signal_returns_risk_decision_type(self) -> None:
...
class TestDuckDBPersistOrder:
    ...
    async def test_write_risk_state_called_before_return(self) -> None:
    ...
    async def test_write_audit_event_called_before_return(self) -> None:
    ...
    async def test_write_called_on_rejection_too(self) -> None:
    ...
    async def test_write_not_called_when_store_is_none(self) -> None:
